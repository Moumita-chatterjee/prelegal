// Ported from ../../templates/Mutual-NDA.md (Common Paper Mutual NDA Standard Terms v1.0, CC BY 4.0).
// Defined terms (Purpose, Effective Date, MNDA Term, Term of Confidentiality, Governing Law,
// Jurisdiction) are cross-references to the Cover Page fields rendered in NdaPreview/NdaPdfDocument,
// left as the literal term names here rather than substituted, matching the source document.
